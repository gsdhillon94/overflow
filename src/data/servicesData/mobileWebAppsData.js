export const mobileWebAppsData = [
  {
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        tag: "p",
        text:
          "You’ve made the decision to outsource your Mobile and Web apps campaign. You’ve looked around and found a few candidates for your BPO. Now it’s time to choose. Have you asked the right questions? Have all of your qualifications been addressed",
      },
      {
        id: "03",
        contentType: "list",
        ...
        cardData: [
          {
            cardID: "card_01",
            cardImg: "girl.jpg",
            cardHeading: "Mobile and Web appss",
            cardDescription:
    ...
    data: [
      {
        ...
        contentType: "text",
        tag: "h1",
        text: "B2B Mobile and Web apps Process",
      },
    ],
  },
  {
